#ifndef __DHCPARSER_H__
#define __DHCPARSER_H__
...
typedef struct eth_hdr_s {
	u_int8_t dstmac[ETHER_ADDR_LEN];
	u_int8_t srcmac[ETHER_ADDR_LEN];
	u_int16_t ethertype;
...
/* UDP headers are always exactly 16 bytes */
...
typedef struct tcp_hdr_s {
    ...
    u_int8_t    offs;       /* data offset, rsvd */
//#define TH_OFF(th)  (((th)->offs & 0xf0) >> 4)
    u_int8_t    flags;
#define TH_FIN  0x01
#define TH_SYN  0x02
#define TH_RST  0x04
...
#define DHCP_OPTION_SIZE_MAX 0xff
...
#define RFC_MAGIC_SIZE 4
char rfc_magic[4]= {99,130,83,99};
